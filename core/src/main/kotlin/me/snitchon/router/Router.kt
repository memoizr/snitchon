...
data class Router(val config: Config = Config(), val prefix: String = "") {
    ...
    inline fun <reified RETURN : Any> Endpoint0<Nothing>.isHandledBy(
        ...
        Endpoint0(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par, reified RETURN: Any>
        ...
        Endpoint1(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par,
        ...
        Endpoint2(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, b, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par, B : Par, C : Par, reified RETURN: Any>
        ...
        Endpoint3(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, b, c, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par, B : Par, C : Par, D : Par, reified RETURN: Any>
        ...
        Endpoint4(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, b, c, d, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par, B : Par, C : Par, D : Par, E : Par, reified RETURN: Any>
        ...
        Endpoint5(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, b, c, d, e, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par, B : Par, C : Par, D : Par, E : Par, F : Par, reified RETURN: Any>
        ...
        Endpoint6(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, b, c, d, e, f, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par, B : Par, C : Par, D : Par, E : Par, F : Par, G : Par, reified RETURN: Any>
        ...
        Endpoint7(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, b, c, d, e, f, g, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par, B : Par, C : Par, D : Par, E : Par, F : Par, G : Par, H : Par, reified RETURN: Any>
        ...
        Endpoint8(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, b, c, d, e, f, g, h, handler)
            .also { addEndpoint(it) }
    ...
    inline fun <A : Par, B : Par, C : Par, D : Par, E : Par, F : Par, G : Par, H : Par, I: Par, reified RETURN: Any>
        ...
        Endpoint9(httpMethod, prefixed(url), summary, description, visibility, before, after, RETURN::class, a, b, c, d, e, f, g, h, i, handler)
            .also { addEndpoint(it) }
}